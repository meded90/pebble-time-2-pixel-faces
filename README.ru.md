...
| Релиз-кандидат · Не опубликован | Релиз-кандидат · Не опубликован | [Установить из RePebble](https://apps.repebble.com/7ffae9b84d714b9882f7a40f) | Эксперимент · Не опубликован |
...
| --- | --- | --- | --- |
| [Mosaic Grid](mosaic-grid/) | Циферблат | 1.1.0 | Крупное время в строгой цветной сетке. |
...
| [Starry Digits](starry-digits/) | Циферблат | 1.2.1 | Рисованные цифры на ночном небе; поддерживается и Round 2. |
...
| [Find My iPhone](find-my-iphone/) | Приложение | 0.1.4 | Экспериментальный прямой запрос Apple Find My через подключённый iPhone. |
