...
- явный запрос и повторная отправка trusted-device 2FA, получение доверенной сессии и выбор iPhone;
...
3. Если Apple потребует 2FA, подтвердите уведомление о входе и введите шестизначный код с доверенного устройства. Если уведомление не появилось, нажмите «Отправить код ещё раз».
...
Текущая версия явно запрашивает 2FA-код на доверенных устройствах и умеет повторять запрос. Отдельный запрос кода по SMS или голосовому звонку не реализован.
