...
[Установить из RePebble](https://apps.repebble.com/mosaic-grid_d2ccde5d2187490085b44f8e).
...
- анимация запуска длительностью 1,05 секунды: блоки по очереди сдвигаются, меняют размер и мягко встают в сетку;
...
Опубликованный пакет: [`../dist/published/mosaic-grid-1.0.2.pbw`](../dist/published/mosaic-grid-1.0.2.pbw).
