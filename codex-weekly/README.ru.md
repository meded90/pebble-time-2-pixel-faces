...
[Установить из RePebble](https://apps.repebble.com/codex-weekly_27f48d86803e471a83b93dfe).
...
`/status` и клиентский токен без сохранения настроек, показывает число
полученных ежедневных bucket’ов Personal Usage (из 84) либо безопасный код
ошибки. Токен в результате проверки не выводится.
...
Опубликованный пакет: [`../dist/published/codex-weekly-1.0.7.pbw`](../dist/published/codex-weekly-1.0.7.pbw).
